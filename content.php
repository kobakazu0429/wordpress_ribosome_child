...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if ( is_single() ) do_action('ribosome_above_single_post_title', $post->ID); ?>
		...
		<footer class="entry-meta">
			...
			// Author info
			if ( is_singular() && get_the_author_meta( 'description' ) )  get_template_part( RIBOSOME_TEMPLATE_PARTS . 'author-info-box');
